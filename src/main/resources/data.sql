...
VALUES
    ('11111111-1111-1111-1111-111111111111', 'jan.kowalski@example.com', 'hashed_password1', 'Jan Kowalski', 1234, '2023-01-01 12:00:00', '2023-01-01 12:00:00'),
    ('22222222-2222-2222-2222-222222222222', 'anna.nowak@example.com', 'hashed_password2', 'Anna Nowak', 5678, '2023-02-01 14:00:00', '2023-02-01 14:00:00'),
    ('33333333-3333-3333-3333-333333333333', 'piotr.wisniewski@example.com', 'hashed_password3', 'Piotr Wiśniewski', 910, '2023-03-01 16:00:00', '2023-03-01 16:00:00'),
    ('44444444-4444-4444-4444-444444444445', 'maria.kaminska@example.com', 'hashed_password4', 'Maria Kamińska', 345, '2023-04-01 18:00:00', '2023-04-01 18:00:00'),
    ('55555555-5555-5555-5555-555555555551', 'tomasz.lewandowski@example.com', 'hashed_password5', 'Tomasz Lewandowski', 6789, '2023-05-01 20:00:00', '2023-05-01 20:00:00'),
    ('66666666-6666-6666-6666-666666666661', 'aleksandra.kaczmarek@example.com', 'hashed_password6', 'Aleksandra Kaczmarek', 4321, '2023-06-01 10:00:00', '2023-06-01 10:00:00'),
    ('77777777-7777-7777-7777-777777777771', 'adam.kowalczyk@example.com', 'hashed_password7', 'Adam Kowalczyk', 876, '2023-07-01 11:00:00', '2023-07-01 11:00:00'),
    ('88888888-8888-8888-8888-888888888881', 'zofia.wojcik@example.com', 'hashed_password8', 'Zofia Wójcik', 5432, '2023-08-01 13:00:00', '2023-08-01 13:00:00'),
    ('99999999-9999-9999-9999-999999999991', 'lukasz.krol@example.com', 'hashed_password9', 'Łukasz Król', 987, '2023-09-01 15:00:00', '2023-09-01 15:00:00'),
    ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'paulina.zajac@example.com', 'hashed_password10', 'Paulina Zając', 12345, '2023-10-01 17:00:00', '2023-10-01 17:00:00'),
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'grzegorz.jablonski@example.com', 'hashed_password11', 'Grzegorz Jabłoński', 2500, '2023-11-01 09:00:00', '2023-11-01 09:00:00'),
    ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'klaudia.adamczyk@example.com', 'hashed_password12', 'Klaudia Adamczyk', 670, '2023-11-02 10:00:00', '2023-11-02 10:00:00'),
    ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'michal.kubiak@example.com', 'hashed_password13', 'Michał Kubiak', 4800, '2023-11-03 11:00:00', '2023-11-03 11:00:00'),
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'elzbieta.mazur@example.com', 'hashed_password14', 'Elżbieta Mazur', 375, '2023-11-04 12:00:00', '2023-11-04 12:00:00'),
    ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'krzysztof.szczepanski@example.com', 'hashed_password15', 'Krzysztof Szczepański', 2980, '2023-11-05 13:00:00', '2023-11-05 13:00:00'),
    ('10101010-1010-1010-1010-101010101010', 'natalia.piotrowska@example.com', 'hashed_password16', 'Natalia Piotrowska', 4500, '2023-11-06 14:00:00', '2023-11-06 14:00:00'),
    ('11111111-1111-1111-1111-111111111112', 'wojciech.kowal@example.com', 'hashed_password17', 'Wojciech Kowal', 3200, '2023-11-07 15:00:00', '2023-11-07 15:00:00'),
    ('12121212-1212-1212-1212-121212121212', 'martyna.gorska@example.com', 'hashed_password18', 'Martyna Górska', 1500, '2023-11-08 16:00:00', '2023-11-08 16:00:00'),
    ('13131313-1313-1313-1313-131313131313', 'kamil.kucharski@example.com', 'hashed_password19', 'Kamil Kucharski', 980, '2023-11-09 17:00:00', '2023-11-09 17:00:00'),
    ('14141414-1414-1414-1414-141414141414', 'justyna.ostrowska@example.com', 'hashed_password20', 'Justyna Ostrowska', 8900, '2023-11-10 18:00:00', '2023-11-10 18:00:00'),
    ('15151515-1515-1515-1515-151515151515', 'patryk.wrona@example.com', 'hashed_password21', 'Patryk Wrona', 725, '2023-11-11 19:00:00', '2023-11-11 19:00:00'),
    ('16161616-1616-1616-1616-161616161616', 'karolina.wilk@example.com', 'hashed_password22', 'Karolina Wilk', 450, '2023-11-12 20:00:00', '2023-11-12 20:00:00'),
    ('17171717-1717-1717-1717-171717171717', 'mateusz.kalinowski@example.com', 'hashed_password23', 'Mateusz Kalinowski', 1900, '2023-11-13 21:00:00', '2023-11-13 21:00:00'),
    ('18181818-1818-1818-1818-181818181818', 'monika.czerwinska@example.com', 'hashed_password24', 'Monika Czerwińska', 2450, '2023-11-14 22:00:00', '2023-11-14 22:00:00'),
    ('19191919-1919-1919-1919-191919191919', 'bartek.olszewski@example.com', 'hashed_password25', 'Bartek Olszewski', 8300, '2023-11-15 23:00:00', '2023-11-15 23:00:00'),
    ('20202020-2020-2020-2020-202020202020', 'agnieszka.lis@example.com', 'hashed_password26', 'Agnieszka Lis', 1520, '2023-11-16 12:00:00', '2023-11-16 12:00:00'),
    ('21212121-2121-2121-2121-212121212121', 'sebastian.zielinski@example.com', 'hashed_password27', 'Sebastian Zieliński', 3650, '2023-11-17 13:00:00', '2023-11-17 13:00:00'),
    ('22222222-2222-2222-2222-222222222223', 'dagmara.borkowska@example.com', 'hashed_password28', 'Dagmara Borkowska', 2780, '2023-11-18 14:00:00', '2023-11-18 14:00:00'),
    ('23232323-2323-2323-2323-232323232323', 'rafal.dudek@example.com', 'hashed_password29', 'Rafał Dudek', 990, '2023-11-19 15:00:00', '2023-11-19 15:00:00'),
    ('24242424-2424-2424-2424-242424242424', 'alina.gajewska@example.com', 'hashed_password30', 'Alina Gajewska', 7850, '2023-11-20 16:00:00', '2023-11-20 16:00:00');
